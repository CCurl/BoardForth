...
void fTIB();             // OP_TIB (#tib)
void fNTIB();            // OP_NTIB (##tib)
void fTOIN();            // OP_TOIN (#>in)
...
void fBASE();            // OP_BASE (#base)
void fSTATE();           // OP_STATE (#state)
void fHERE();            // OP_HERE (#(here))
void fLAST();            // OP_LAST (#(last))
